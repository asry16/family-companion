  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      <ScrollView
        ...
        {/* ========================================================================= */}
        {/* SECTION 1: LIVE FAMILY PRESENCE CAROUSEL                                  */}
        {/* ========================================================================= */}
        <View style={styles.sectionHeaderRow}>
          <View style={styles.sectionHeaderTitleBlock}>
            <Ionicons name="radio-outline" size={16} color={colors.brandAccent} />
            <Text
              style={[
          ...
          <Pressable
            onPress={() => router.push('/(tabs)/family')}
            hitSlop={8}>
            <Text style={[styles.sectionSeeAll, { color: colors.brandAccent }]}>
              See Map →
            </Text>
          </Pressable>
        </View>
        ...
        <View style={styles.sectionHeaderRow}>
          <View style={styles.sectionHeaderTitleBlock}>
            <Ionicons name="map" size={16} color={colors.brandAccent} />
            <Text
              style={[
                styles.sectionHeaderTitle,
                { color: colors.text, fontSize: isElderly ? 19 : 15 },
